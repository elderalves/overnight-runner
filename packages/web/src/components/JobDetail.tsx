...
export interface JobDetailJob {
  ...
  notes?: string;
  // Live-only (see CONTEXT.md "Phase" / "Activity note" / "Activity"):
  // populated only for the live wire Job while it's the running job this
  // server session; a historical RunHistoryRow never carries these.
  currentPhase?: string;
