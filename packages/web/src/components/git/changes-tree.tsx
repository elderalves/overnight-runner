...
function DirNode({ dir, depth, selected, onSelect }: { dir: TreeDir; depth: number; selected: string | null; onSelect: (path: string) => void }) {
...
function FileNode({ file, depth, selected, onSelect }: { file: TreeFile; depth: number; selected: string | null; onSelect: (path: string) => void }) {
